...
<div class="top-bar">
    <h1>Surat <span id="nama_surat"><?php echo $nama_surat;?></span></h1>
        <div class="breadcrumbs">Nomor : <?php echo $nomer_surat;?></div>

       <div id="stylized" class="select-bar" style="width: 1000px; height: 500px; background-color: transparent;">
<div class="info proses"></div>		
<form id="form" name="form" method="post" action="simpan_surat.php" style="padding-top: 1cm">
<?php
if($jenis_surat == "SM"){
?>	
<label>Nama 
...
<input type="text" name="nama" id="nama" class="isian tampil bag_atas" style="width: 400px" />
<span class="ket"></span>
<label>Jenis Kelamin
<span class="small">L = laki - laki, W = wanita</span>
</label>
<input type="text" name="j_kel" id="j_kel" class="isian tampil bag_atas" style="width: 400px"/>
<span class="ket"></span>
<label>Alamat
<span class="small">Alamat rumah</span>
</label>
<textarea name="alamat" id="alamat" class="isian tampil bag_atas" style="width: 400px"/></textarea>
<span class="ket"></span>
<label>Hari
<span class="small">Hari ketika wafat</span>
</label>
<input type="text" name="hari" id="hari" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<label>Tanggal
<span class="small">Tanggal wafat</span>
</label>
<input type="text" name="tanggal" id="tanggal" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<label>Di
<span class="small">Kota tempat wafat</span>
</label>
<input type="text" name="di" id="di" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<label>Disebabkan
<span class="small">Sebab wafat</span>
</label>
<input type="text" name="sebab" id="sebab" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<?php
}
else {
...
<input type="text" name="nama_bayi" id="nama_bayi" class="isian tampil bag_atas" style="width: 400px"/>
<span class="ket"></span>
<label>Hari
<span class="small">Hari ketika lahir</span>
</label>
<input type="text" name="hari" id="hari" class="manual tampil bag_atas" style="width: 400px"/>
<span class="ket"></span>
<label>Tanggal
<span class="small">Tanggal kelahiran</span>
</label>
<input type="text" name="tanggal" id="tanggal" class="manual tampil bag_atas" style="width: 400px"/>
<span class="ket"></span>
<label>Di
<span class="small">Tempat lahir</span>
</label>
<input type="text" name="di" id="di" class="manual tampil bag_atas" style="width: 400px"/>
<span class="ket"></span>
<label>Jenis Kelamin
<span class="small">L = laki - laki, W = wanita</span>
</label>
...
<input type="text" name="nama_ibu" id="nama_ibu" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<label>Ayah
<span class="small">Nama ayah</span>
</label>
<input type="text" name="nama_ayah" id="nama_ayah" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<label>Alamat
<span class="small">Alamat orang tua</span>
</label>
<input type="text" name="alamat" id="alamat" class="manual tampil bag_bawah" style="width: 400px"/>
<span class="ket"></span>
<?php
}
?>
...
<div style="text-transform:uppercase;text-decoration:underline;font-weight:bolder">Surat <?php echo $nama_surat;?></div>
    <div>Nomor : <?php echo $nomer_surat;?></div>
</div>
<div id="par_pembuka">
...
dapat dipergunakan sebagaimananya.</div>
<div class="tanda_tangan" style="float:right">
	<div>Lumban Sitorus, <?php echo date("d-m-Y") ?></div>
