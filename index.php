...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="background-color: lavender">
  ...
  <li class="nav-item">
    <a class="nav-link" href="pemerintahandesa.php"><i class="fa fa-list"></i> Pemerintah Desa</a>
  </li>
  <li class="nav-item">
        ...
        <section id="templatemo_services" style="background-color: skyblue">
            <div class="container">
                <div class="row" style="text-align: center;">
                    ...
                    <br>
                    <h2>Visi:</h2>
                    "Terbangunnya tata kelola Pemerintahan Desa yang baik dan bersih <br>guna terwujudnya kehidupan masyarakat desa yang adil, makmur dan sejahtera serta berbudaya dan berakhlak mulia."
