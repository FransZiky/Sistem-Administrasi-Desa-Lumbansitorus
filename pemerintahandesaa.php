...
<section id="templatemo_about">
    ...
    <div class="row, container">
        ...
        <table>
            <tr>
                <td>Ketua Badan Permusyawaratan Desa</td>
                <td>:</td>
                <td>Jumri Sitorus</td>
            </tr>
            <tr>
                <td>Wakil Ketua Badan Permusyawaratan Desa</td>
                <td>:</td>
                <td>Marojahan Sitorus</td>
            </tr>
            <tr>
                <td>Sekretaris Badan Permusyawaratan Desa</td>
        ...
        <table>
            ...
            <tr>
                <td>Kepala Urusan Tata Usaha & Umum</td>
                <td>:</td>
