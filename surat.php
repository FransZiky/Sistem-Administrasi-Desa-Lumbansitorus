...
if($jenis_surat == "SKA"){
	...
	$field_tambahan ='<label>Pindah ke
					...
					<div class="table" border="1" style="clear:both;position:relative;margin-left:10px;background:none">
					<table class="listing" border="1" id="tab_pengikut" cellpadding="0" cellspacing="0">
...
<div id="stylized" class="select-bar" style="width: 1000px; height: 800px; background-color: transparent;">
...
<input type="text" name="nama" id="nama" class="isian tampil" style="width: 400px" />
<span class="ket"></span>
<label >Tempat, Tanggal Lahir
<span class="small">Tempat dan tanggal lahir</span>
</label>
<input type="text" name="t_lahir" id="t_lahir" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Jenis Kelamin
<span class="small">L = laki - laki, W = wanita</span>
</label>
<input type="text" name="j_kel" id="j_kel" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Kewarganegaraan
<span class="small">Kewarganegaraan</span>
</label>
<input type="text" name="w_negara" id="w_negara" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Pendidikan
<span class="small">Pendidikan terakhir</span>
</label>
<input type="text" name="pendidikan" id="pendidikan" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Agama
<span class="small">Agama yang dianut</span>
</label>
<input type="text" name="agama" id="agama" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Pekerjaan
<span class="small">Pekerjaan yang ditekuni</span>
</label>
<input type="text" name="pekerjaan" id="pekerjaan" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Status pernikahan
<span class="small">Status pernikahan</span>
</label>
<input type="text" name="s_nikah" id="s_nikah" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Nomer KTP
<span class="small">No. KTP / NIK</span>
</label>
<input type="text" name="no_ktp" id="no_ktp" class="isian tampil" style="width: 400px"/>
<span class="ket"></span>
<label>Alamat
<span class="small">Alamat rumah</span>
</label>
<textarea name="alamat" id="alamat" class="isian tampil" style="width: 300px"/></textarea>
<span class="ket"></span>
<?php 
	...
	$("#nama").autocomplete({
			source: function(request,response){
				...
				var sql  = "SELECT no_ktp, nama, agama,t_lahir,tgl_lahir,j_kel, w_negara,";
				    sql += "pendidikan, pekerjaan, s_nikah, alamat,dusun FROM v_detail_warga ";
				    sql += " WHERE nama LIKE '";
